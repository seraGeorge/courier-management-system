...
export default function DashboardPageContent() {
  ...
  const totalPackages =
    dashboard.pendingPackages.count +
    dashboard.activePackages.count +
    dashboard.delayedPackages.count +
    dashboard.outForDeliveryPackages.count +
    dashboard.deliveredPackages.count;
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <DashboardCard
          ...
          variant="active"
          description="Picked up / in transit"
          icon={
            <svg
              className="w-5 h-5"
              fill="none"
